// Testcase Description: Checks the functionality of credit card workflow when buyer does not have money while buying
...
//	createsvc.clktxtsubCategoryField();
	...
	act.moveToElement(homepg.actWelcome()).moveToElement(homepg.actSignout()).click().build().perform();
		...
		//Login as a buyer; search for a bid and select to Buy i.e. 'I want this' option
		@Test(priority=9802)
		public void Buyerlogin_SearchBid_NegotiateWithoutEeds() throws IOException, InterruptedException
		{
			...
			logger.info("VALIDATE - Buying without Eeds displays Insufficient EEDS popup!!");
			SoftAssert softassert = new SoftAssert();
		...
		public void SellerLogin_DeleteService() throws IOException, InterruptedException
		{
			...
			logger.info("Completed TP_TC_098");
		}
