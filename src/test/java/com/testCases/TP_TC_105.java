...
b) Do not enter any details of Credit card and push 'Submit payment' button to proceed" */

/* Acceptance Criteria: "The test cae to be considered successful, following should happen:
a) Payment not successful
b) The error message 'Your card number is incomplete' is displayed" */

public class TP_TC_105 extends BaseClass {
	
		@Test(priority = 10501)
		public void SellerLogin_CreateService() throws InterruptedException, IOException {

			logger.info("Started TP_TC_105");
		...
		// Purchase eeds with blank credit card information pop up opens
		@Test(priority = 10502)
		public void Buyerlogin_BuyBidwithInsufficientBalance_PurchaseEedsBlank() throws IOException, InterruptedException {
			...
			if (creditcard.gettxtINSUFFICIENTEEDS().contains("INSUFFICIENT EEDS")) {
				...
				logger.info("Leave credit card information blank and click on Pay");
				creditcard.clickpaybtn();
				
				//Validation of incomplete credit card details begins here

				if (creditcard.gettxtcreditcardblankerror().contains("Your card number is incomplete")) {
					softassert.assertTrue(true);
		...
		public void SellerLogin_DeleteService() throws InterruptedException {
			...
			logger.info("Completed TP_TC_105");
		}
