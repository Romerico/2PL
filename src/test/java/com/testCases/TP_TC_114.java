...
/* Testcase Description: Testing the functionality to validate whether the account balance displayed in Profile Page 
  gets updated while bidding/buying a service */

/* Acceptance Criteria: "This testcase is successful if
1. Profile Total Balance gets updated with the amount while buying/bidding a service" */

//User1 : Buyer ; User2: Seller

public class TP_TC_114 extends BaseClass {

	SoftAssert softassert = new SoftAssert();
	public String serviceName = "NP Walnut Services";
	...
	public void SellerLogin_CreateService() throws IOException, InterruptedException
	{
		...
		//Note the "Total Balance" of the Seller before the Selling the Service
	...
	public void BuyerLogin_BuyService() throws IOException, InterruptedException
	{
		...
		//Navigating to User1's Profile Page
				Actions act = new Actions(driver);
				act.moveToElement(homepg.actWelcome()).moveToElement(homepg.actProfile()).click().build().perform();
		
		//Note the "Total Balance" of the Buyer before buying the Service
				ProfilePage pp = new ProfilePage(driver);
	...
	public void BuyerLogin_calculateTotalBalance() throws IOException, InterruptedException
	{
		...
		Actions act = new Actions(driver);
		act.moveToElement(homepg.actWelcome()).moveToElement(homepg.actProfile()).click().build().perform();
		logger.info("Navigating to User1's Profile Page");
	...
	public void SellerLogin_CalculateTotalBalance() throws IOException, InterruptedException
	{
		...
		Actions act = new Actions(driver);
		act.moveToElement(homepg.actWelcome()).moveToElement(homepg.actProfile()).click().build().perform();
		logger.info("Navigating to User2's(Seller's) Profile Page");
		...
		//Calculate the "Total Balance" for User2 after the Sale of the Service
	...
	public void SellerLogin_DeleteSvc() throws IOException, InterruptedException
	{
		...
		softassert.assertAll();	
	logger.info("Completed TP_TC_114");	
	}
